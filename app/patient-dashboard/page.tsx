...
import { User, Calendar, Heart, Pill, Activity, FileText, Bell, LogOut } from 'lucide-react'
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">Пациент: {userName}</h1>
                <p className="text-sm text-gray-600">Личный кабинет пациента</p>
              </div>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-gradient-to-r from-green-600 to-blue-600 text-white rounded-2xl p-8 mb-8">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-2xl font-bold mb-2">Добро пожаловать, {userName?.split(' ')[1] || 'Иван'}!</h2>
        ...
        {/* Demo Info */}
        <div className="mt-8 p-6 bg-gradient-to-r from-gray-900 to-gray-800 text-white rounded-2xl">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-lg font-bold mb-2">Демо-режим пациента</h3>
              <p className="text-gray-300">Это демонстрационная версия личного кабинета пациента.</p>
              <p className="text-gray-400 text-sm mt-1">В реальной системе здесь будет ваша персональная медицинская информация.</p>
            </div>
